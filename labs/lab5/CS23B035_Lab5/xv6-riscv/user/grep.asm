...
00000000000001de <main>:
{
 ...
 252:	80258593          	addi	a1,a1,-2046 # a50 <malloc+0xf4>
 256:	4509                	li	a0,2
 ...
 288:	7ec50513          	addi	a0,a0,2028 # a70 <malloc+0x114>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 60e:	48650513          	addi	a0,a0,1158 # a90 <digits>
 612:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6da:	3bab8b93          	addi	s7,s7,954 # a90 <digits>
 ...
 81a:	27290913          	addi	s2,s2,626 # a88 <malloc+0x12c>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 a14:	ec4080e7          	jalr	-316(ra) # 8d4 <free>
  return freep;
 ...
 a36:	b7c080e7          	jalr	-1156(ra) # 5ae <sbrk>
  if(p == (char*)-1)
