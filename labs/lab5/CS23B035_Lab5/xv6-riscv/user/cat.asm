...
cat(int fd)
{
  ...
  72:	87a58593          	addi	a1,a1,-1926 # 8e8 <malloc+0x10c>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 106:	7fe58593          	addi	a1,a1,2046 # 900 <malloc+0x124>
 10a:	4509                	li	a0,2
...
malloc(uint nbytes)
{
 ...
 894:	ec4080e7          	jalr	-316(ra) # 754 <free>
  return freep;
 ...
 8b6:	b7c080e7          	jalr	-1156(ra) # 42e <sbrk>
  if(p == (char*)-1)
